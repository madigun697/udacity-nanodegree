...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        hidden_error = error[:, None].dot(self.weights_hidden_to_output.T)
        ...
        delta_weights_i_h += np.dot(X[:, None], hidden_error_term) * self.lr
        # Weight step (hidden to output)
        delta_weights_h_o += np.dot(hidden_outputs[:, None], output_error_term) * self.lr
